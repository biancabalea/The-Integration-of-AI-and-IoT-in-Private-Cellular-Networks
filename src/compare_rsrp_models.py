...
LINEAR_PATH = METRICS_DIR / "linear_regression_rsrp_metrics.csv"
RF_PATH = METRICS_DIR / "random_forest_rsrp_metrics.csv"

OUTPUT_COMPARISON_CSV = METRICS_DIR / "rsrp_models_comparison.csv"
OUTPUT_COMPARISON_PNG = FIGURES_DIR / "rsrp_models_comparison.png"

def main():
    print("=== COMPARATIE MODELE RSRP ===")
    ...
    plt.xlabel("Model")
    plt.ylabel("R2")
    plt.title("Comparatie modele pentru predictia RSRP")
    plt.ylim(0, 1.05)
