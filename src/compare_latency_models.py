...
LINEAR_PATH = METRICS_DIR / "linear_regression_latency_metrics.csv"
RF_PATH = METRICS_DIR / "random_forest_latency_metrics.csv"

OUTPUT_COMPARISON_CSV = METRICS_DIR / "latency_models_comparison.csv"
OUTPUT_COMPARISON_PNG = FIGURES_DIR / "latency_models_comparison.png"

def main():
    print("=== COMPARATIE MODELE LATENCY ===")
    ...
    plt.xlabel("Model")
    plt.ylabel("R2")
    plt.title("Comparatie modele pentru predictia latency")
    plt.ylim(0, 1.05)
