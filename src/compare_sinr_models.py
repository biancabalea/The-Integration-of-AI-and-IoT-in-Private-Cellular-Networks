...
LINEAR_PATH = METRICS_DIR / "linear_regression_sinr_metrics.csv"
RF_PATH = METRICS_DIR / "random_forest_sinr_metrics.csv"

OUTPUT_COMPARISON_CSV = METRICS_DIR / "sinr_models_comparison.csv"
OUTPUT_COMPARISON_PNG = FIGURES_DIR / "sinr_models_comparison.png"

def main():
    print("=== COMPARATIE MODELE SINR ===")
    ...
    plt.xlabel("Model")
    plt.ylabel("R2")
    plt.title("Comparatie modele pentru predictia SINR")
    plt.ylim(0, 1.05)
