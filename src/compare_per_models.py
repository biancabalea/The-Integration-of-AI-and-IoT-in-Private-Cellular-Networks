...
LINEAR_PATH = METRICS_DIR / "linear_regression_per_metrics.csv"
RF_PATH = METRICS_DIR / "random_forest_per_metrics.csv"

OUTPUT_COMPARISON_CSV = METRICS_DIR / "per_models_comparison.csv"
OUTPUT_COMPARISON_PNG = FIGURES_DIR / "per_models_comparison.png"

def main():
    print("=== COMPARATIE MODELE PER ===")
    ...
    plt.xlabel("Model")
    plt.ylabel("R2")
    plt.title("Comparatie modele pentru predictia PER")
    plt.ylim(0, 1.05)
